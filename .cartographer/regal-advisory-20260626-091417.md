...
- **Timestamp**: 2026-06-26T09:14:17-04:00

## Findings (raw)

```json
A new version of Regal is available (v0.41.1). You are running 0.40.0.
See https://github.com/open-policy-agent/regal/releases/tag/v0.41.1 for the latest release.
{
  "violations": [
    {
