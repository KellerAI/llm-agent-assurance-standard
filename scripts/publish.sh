#!/usr/bin/env bash
# publish.sh — publication helper for llm-agent-assurance-standard.
#
...
#
# Usage:
#   publish.sh --repo KellerAI/llm-agent-assurance-standard --description "TEXT" [OPTIONS]
#
# Options:
...
#   --repo        defaults to KellerAI/llm-agent-assurance-standard
#   --description defaults to "LLM-Agent Assurance Standard (LAAS) — normative spec, OPA enforcement policy, and reference tooling for action-level assurance of autonomous LLM agents"
...
# ---------------------------------------------------------------------------
DEFAULT_REPO="KellerAI/llm-agent-assurance-standard"
DEFAULT_DESCRIPTION="LLM-Agent Assurance Standard (LAAS) — normative spec, OPA enforcement policy, and reference tooling for action-level assurance of autonomous LLM agents"
